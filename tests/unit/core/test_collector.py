...
def test_collector_initialize_collection():
    ...
    from anansi import Collector, Collection
...
async def test_collector_with_getter():
    ...
    from anansi import Model, Collector, Collection
...
async def test_collector_reverse_lookup_collection_context():
    ...
    from anansi import Model, Collector, Field, Query
    ...
    assert children.context.where.left is 'parent_id'
    assert children.context.where.op is Query.Op.Is
    assert children.context.where.right is page
